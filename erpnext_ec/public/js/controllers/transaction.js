...
//console.log('Si esta aquiiiiiiiiiiiiii!!!');

erpnext_ec.TransactionController = class TransactionController extends erpnext.taxes_and_totals {
	setup() {
		console.log('En el Setup!!!');
		super.setup();
		let me = this;
