...
function SetupCustomButtons(doc, DocTypeErpNext)
{
  ...
  <div class="dropdown-menu" aria-labelledby="dropdownMenuLink">
    <a class="dropdown-item hide" href="javascript:document.Website.DownloadXml_v2('` + doc.name + `'); "><i class="fa fa-file-code-o" aria-hidden="true"></i> Xml ${doc.name}</a>
	<a class="dropdown-item hide" href="javascript:document.Website.DownloadPdf_v2('` + doc.name + `'); "><i class="fa fa-file-pdf-o" aria-hidden="true"></i> Pdf ${doc.name}</a>
    <a class="dropdown-item hide" href="javascript:return; ">-</a>
